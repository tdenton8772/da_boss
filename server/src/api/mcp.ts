...
import { SUPPORTED_MODELS, DEFAULT_MODEL } from "../models.js";
  ...
  server.registerTool(
    "create_agent",
    {
      ...
      inputSchema: {
        ...
        model: z.string().optional().describe(`Defaults to ${DEFAULT_MODEL} (code work). Options: ${SUPPORTED_MODELS.join(" | ")}`),
